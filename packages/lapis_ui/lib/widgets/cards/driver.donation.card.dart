...
class DriverDonationCard extends StatefulWidget {
  const DriverDonationCard(
  ...
  @override
  State<DriverDonationCard> createState() => _DriverDonationCardState();
}

class _DriverDonationCardState extends State<DriverDonationCard> {
  @override
