...
class KidPositionAnimation extends StatefulWidget {
  KidPositionAnimation(
      {Key? key,
      required this.child,
      required this.delay,
      required this.milli,
  ...
  @override
  _KidPositionAnimationState createState() => _KidPositionAnimationState();
}

class _KidPositionAnimationState extends State<KidPositionAnimation>
