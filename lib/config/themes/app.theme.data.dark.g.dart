...
part of 'app.theme.data.dark.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AppThemeDataDark _$AppThemeDataDarkFromJson(Map<String, dynamic> json) => AppThemeDataDark(
...
Map<String, dynamic> _$AppThemeDataDarkToJson(AppThemeDataDark instance) =>
    <String, dynamic>{
      'name': instance.name,
